 ...
 */(function(e){
	 e.fn.slimtable=function(t)
	 {
		 ...
		 for(var o=0;o<n.ipp_list.length;o++)
		 {
			 ...
			 e(s).append(u)}e(s).on("change",m),
			 e(s).addClass("slimtable-paging-select"),
			 i=document.createElement("div"),
			 e(i).addClass("slimtable-paging-btnsdiv"),
			 e(r).append(i),a=i,i=document.createElement("div"),
			 e(i).addClass("slimtable-paging-seldiv"),
			 e(i).append(s),e(i).append("items/page"),
			 e(r).append(i),i=document.createElement("div"),
			 e(i).addClass("slimtable-container-div"),
			 e(i).append(r),t.before(i),
			 t.insertBefore(r)
			 }
		function h()
		{
			o.find("th").each(function(t)
			{
				...
				if(r[t]&&r[t].sortable)
				{
					...
					e(n).addClass("slimtable-sprites"),
